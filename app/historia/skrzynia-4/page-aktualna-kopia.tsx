...
import MapaPowiekszenie from "@/components/MapaPowiekszenie";
    ...
    <main className={styles.page}>
      <article className={styles.kronika}>
        ...
        <section className={styles.section}>
          ...
          <h2>
            Krzekotów na mapie Głogowa i okolic – 1928 rok
          </h2>

          <div className={styles.markdown}>

            <p>
              Dawne mapy pozwalają odtworzyć wygląd miejscowości
              sprzed wielu dziesięcioleci. Pokazują nie tylko nazwy,
              ale również dawny układ dróg, pól, lasów i zabudowy.
            </p>

            <p>
              Mapa Głogowa i okolic z 1928 roku przedstawia krajobraz
              regionu w okresie międzywojennym. Jest świadectwem świata,
              który został zmieniony przez wydarzenia XX wieku.
            </p>
