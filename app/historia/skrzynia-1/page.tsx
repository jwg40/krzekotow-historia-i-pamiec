...
export default async function Skrzynia1() {
  const skrzynia = getSkrzynia("skrzynia-1");
      ...
      <article className={styles.kronika}>
        ...
        <section className={styles.next}>
          ...
          <p className={styles.text}>
            Pierwsza skrzynia została otwarta.
          </p>

          <p className={styles.text}>
            Historia Krzekotowa dopiero się rozpoczyna.
          </p>
